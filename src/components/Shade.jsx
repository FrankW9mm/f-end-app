  ...
  return (
    <div className="w-full relative text-white mt-[30px] flex flex-col">
      ...
      <div className="  p-3 w-full bg-[#191919] relative flex flex-col justify-start items-start gap-[40px]">
        ...
        {/* Palette */}
        {state.ShowPalette && (
          <div className=" z-10 absolute p-[2rem] flex flex-col justify-center items-center top-0 left-0 w-full h-auto bg-[#191919]">
            <div className="w-full flex flex-row justify-between">
              <h1 className=" uppercase text-[20px]">Explore our color palettes</h1>
